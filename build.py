...
set(project_name FractalExplore)
...
def build():
    ...
    if operating_system == "windows":
        if not os.path.exists("FractalExplore.exe"):
            return
    else:
        if not os.path.exists("FractalExplore"):
            return
    ...
    if operating_system == "windows":
        shutil.copy("FractalExplore.exe", "build")
    else:
        shutil.copy("FractalExplore", "build")
